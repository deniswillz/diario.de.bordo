...
export const analyzeDailyLogs = async (data: AppState) => {
  ...
  const prompt = `
    Analise os seguintes dados do Diário de Bordo da Agrosystem:
    ...
    Forneça um resumo executivo de 3-4 frases em português sobre o estado atual do sistema, 
    identificando possíveis gargalos ou tendências urgentes.
  `;
